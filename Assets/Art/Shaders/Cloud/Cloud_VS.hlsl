// Cloud 用 頂点シェーダー (DxLib Direct3D 11 / QuadRendererの板ポリゴン用)
//
...
// (LatticeBarrier_VS.hlsl / ProximityReveal_VS.hlsl と同じ変換手順。
//  QuadRendererのDrawPrimitive3DToShader2(VERTEX3D配列)経由で描画される)
