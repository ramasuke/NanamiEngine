...
CEREAL_REGISTER_TYPE(GameCore::Npc::Friendly::Behaviour::Action::OpenShop)
CEREAL_REGISTER_POLYMORPHIC_RELATION(GameCore::Npc::Friendly::Behaviour::ActionBase, GameCore::Npc::Friendly::Behaviour::Action::OpenShop)
