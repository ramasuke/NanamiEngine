...
namespace GamePlay::PlayerAvatar
{
    ...
    class WakeUpArea final : public Component::ComponentBase,
                             public Physics::Callback::ISensorEnterable,
                             public Physics::Callback::ISensorExitable
    {
    public:
        [[nodiscard]] std::weak_ptr<IPlayerWakeable> CatchWakeUpTarget();
    ...
    private:
        ...
        std::vector<std::weak_ptr<IPlayerWakeable>> wakeableTargets_;
...
ENGINE_REGISTER_COMPONENT(GamePlay::PlayerAvatar::WakeUpArea, 0)
