...
{
    void SwordManControlGuideRow::CatchParts()
    {
        if (isPartsCaught_)
            return;
        isPartsCaught_ = true;
    ...
    void SwordManControlGuideRow::SetContent(const std::weak_ptr<Asset::SpriteFile>& glyph, const std::string& label)
    {
        CatchParts();
    ...
    void SwordManControlGuideRow::SetFocused(const bool isFocused)
    {
        CatchParts();
    ...
    void SwordManControlGuideRow::Apply(const Appearance& appearance)
    {
        CatchParts();
    ...
    void SwordManControlGuideRow::OnDrawGui()
    {
