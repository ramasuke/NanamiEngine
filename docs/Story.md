...
- 各狩り場の島には、その島の人たちの物語と、拠点の島から飛んでいった **浮遊石** がひとつずつある。
- 島を直すと、施設・住人・行き先が増える。直した島そのものが船になって、最終決戦の舞台になる。
- 狩り場は **2つ**（草原の島・砂の島）、浮遊石も **2つ**（緑・光）。工数を抑えるため、岩石地帯と火の浮遊石はやめた（2026-09-24）。
...
- 島は、底に埋まった **浮遊石** の力で浮いている。拠点の島には緑・光の **2つ** の浮遊石があり、
  ...
  浮遊石が2つある島は珍しい（青年の台詞）。
- **浮遊石は引き合い、ものを引き寄せ、持ち上げる**。物語の不思議は、このひとつのルールで説明する。
  - 獣や魔物を引き寄せる。石が落ちた島には群れが集まり、強いものほど石の傍に居着く。石を持ち去れば獣は散る。
  - 【仮】島の底に埋まっている間は土に抑えられて静かで、むき出しになると呼び始める（取り戻した石を埋め戻せば、もう呼ばない）。
  - 周りの土を持ち上げる。落ちた石の周りでは土くれや岩がゆっくり浮かぶ（石の在りかが遠くから分かる。石が去ると浮かなくなる）。
    → `GreenCoreAura` / `LightCoreAura` の `Debris` / `Chunks`（`tools/art/green_core_effect.py`）。
    落ちた石が島ごと浮き上がっていく（放っておくと取り戻せない）という設定は **使わない**（急がず稼ぐ遊び方と食い違う）。
  - 石どうしが引き合う。抜けた石は、近くの島の石に引かれてそこへ落ちた。
  - 戻った心臓は、沈んだ島を引き上げる（草原の後に噴水の島が雲海から戻ってくる）。
- **ハンター** は、島々で魔物を狩って報酬を得る稼業。拠点の島は、駆け出しのハンターが集まって鍛える島。
  （表向き。本当の起こりは下の「昔の話」）
- 狩り場の島には属性がある。浮遊石の色はこの属性に合わせる。
...
3. **竜の心臓は、死ぬと石になる。** その石には、ものを引き寄せ、持ち上げる力がある（= 浮遊石）。
...
| 古竜 | `FirstEventDragon` | 喋らない | 最後に生き残った竜。仲間の心臓（浮遊石）を島々から取り戻し、巣で仲間を蘇らせようとしている【確定】。名前は【未設計】 |
...
| 骸竜 | `SkeletonDragon`（ボス） | 喋らない | クノイチの故郷の島を浮かせていた竜の骨に、落ちてきた光の浮遊石（別の竜の心臓）が宿って起き上がったもの。城塞の神殿前の広場に居着く【確定】 |

## 4. 章立て

### 序章 — 襲来（`FirstTouchDownMainIsLandScene`）【確定・大部分は実装済み】

序章でいきなり戦うので、戦う前に **島は浮いている / 浮かせているのは島の底の浮遊石（島の心臓）/ ハンターは狩り場で魔物を狩って稼ぐ**
の3つだけは伝える【確定】（2026-09-25）。竜が何者か・なぜ心臓を狙うかは伏せる（クノイチが知っていそう、で引っぱる）。
ナレーションは使わず、次の3か所で見せる。

1. 主人公が飛行船で拠点の島に着く。船上でクノイチと青年に会う。（実装済み）
   青年が窓の外の島を見て、浮遊石と「島の心臓」を話す（`AirShipYoungMan`）。クノイチは「浮遊石の光は、遠くからでも見える。
...
2. 教官の訓練を受ける（走る・跳ぶ・斬る・転がって躱す）。（実装済み）
   ...
   「浮遊石が狙いか！」が伝わる。置き場所と道すじはエディタで見て決める。
...
- 教官の説明: 島を浮かせ続けるには浮遊石を戻すしかない。石は近くの島の石に引かれて、よその島へ落ちた。
...
- 長老は一族の言い伝えとして「島の心臓は、昔は本当に竜の心臓だったと言う」と話す【確定・台詞は未実装】。
...
- 城塞は、この砂の島に **墜ちてきた別の島** の成れの果てで、**クノイチの故郷**。古竜に心臓（浮遊石）を奪われて落ちた。
  東の尾根に、落ちたときに割れた島の底から出てきた **竜の骨** がある。その島を浮かせていた竜の亡骸で、胸にあった心臓が島の浮遊石だった。
  両翼だけが残り、頭と胸の骨が無く、砂の跡が城塞へ続いている。
- ボスは **骸竜**（`SkeletonDragon`）= 城塞に落ちた光の浮遊石（別の竜の心臓）が骨を引き寄せ、宿って起き上がったもの。
...
- 2つの浮遊石がそろうと、島の心臓が戻り、島が自力で飛べるようになる。そのまま終章へ【確定】（演出は【未設計】）。
  そろった心臓は、古竜の巣に積まれた仲間の心臓に引かれる。島はその引く方へ飛び、巣の場所が分かる【確定】。
...
- 復興した島そのものを船にして、心臓が引く方へ、嵐（既存の `SetStorm` / `Lightning`）を抜けて古竜の巣へ向かう。
...
- クノイチと共闘して古竜を倒す。
- 【仮】結末: 古竜の心臓も石になる。集められた心臓の光は、それぞれの島へ還る。古竜の心臓は、クノイチの落ちた故郷を浮かせる
  （あるいは新しい島になる）。最後の竜が島を生み、人は今度こそ、竜の犠牲の上に暮らしていることを忘れずに受け継ぐ。
- エピローグ: ほかの島から人が集まり始める。教官は「駆け出しの島」を再開する。

ステージの作り方（専用シーンか、ロード画面の演出か）と、骸たちを戦わせるかは【未設計】。

### 空の話に合わせて直す台詞【未実装】（2026-09-25）

`tools/art/story_npcs.py` の `CHATS`。どれも、地上という言葉や「喰う」をやめ、今の設定に合わせる。

| 台詞 | 直すところ |
| --- | --- |
| `AirShipYoungMan` | 「島はもとは地上の土地で」→ 雲の下に沈んだ大地の言い伝えに |
| `Introduction ActionInstructure` | 「地上の狩り場には」→ よその島の狩り場 |
| `Instructor_RestorationStart` | 「下の狩り場へ飛んでいった」→ よその島へ（近くの石に引かれて） |
| `CampPeopleElder_*` | 竜の心臓の言い伝えを足す |
| `DesertKunoichi_*` | 「守り竜」「心臓を喰われて」→ 島を浮かせていた竜の骨、心臓を奪われて。骸竜の後に真相の一部 |
...
| 序章 | 青年（船上） | `AirShipYoungMan`（浮かぶ島・浮遊石・島の心臓の説明） |
...
- 大地が雲に呑まれた理由。教官が竜狩りのことを知っているか。終章で竜狩りの真相を誰が明かすか。
