...
- 島は、底に埋まった **浮遊石** の力で浮いている。拠点の島には緑・光の **2つ** の浮遊石があり、
  ...
  - 【仮】浮遊石が2つある島は珍しい（青年の台詞。2026-09-25）。
- **浮遊石は周りの土を持ち上げる**【確定】（2026-09-25）。
  - 見た目: 狩り場に落ちた石の周りでは、土くれや岩がゆっくり浮かび、クレーターの縁の岩も少し浮いている。
    石の在りかは、群れのほかにこれでも遠くから分かる。石が去ると浮かなくなる。
    → `GreenCoreAura` / `LightCoreAura` の `Debris` / `Chunks`（`tools/art/green_core_effect.py`）。
  - 成り立ち: 長い時をかけると、石は大地ごと空へ持ち上げる。**空の島々は、もとは地上の土地で、そうして生まれた。**
    序章の船上で青年が話す（`AirShipYoungMan`）。
  - 狩り場に落ちた石が土地ごと浮き上がっていく（放っておくと取り戻せなくなる）という設定は **使わない**【確定】。
    時間制限のように見えると、急がず稼ぐ遊び方と食い違うため。狩り場の土地が浮き上がることはない。
