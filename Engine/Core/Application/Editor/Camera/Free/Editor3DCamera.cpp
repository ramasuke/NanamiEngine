...
namespace NanamiEngine::Module::Component
{
    ...
    {
        constexpr float aspect = static_cast<float>(Core::Application::Configuration::AppConfiguration::GetWindowWidth()) / static_cast<float>(Core::Application::Configuration::AppConfiguration::GetWindowWidth());
