...
NanamiEngine::Module::Component::Editor3DCamera::Editor3DCamera()
    : previewMousePos_()
{
...
void NanamiEngine::Module::Component::Editor3DCamera::OnUpdate()
{
...
glm::mat4 NanamiEngine::Module::Component::Editor3DCamera::GetViewMatrix() const
{
...
glm::mat4 NanamiEngine::Module::Component::Editor3DCamera::GetProjectionMatrix() const
{
...
void NanamiEngine::Module::Component::Editor3DCamera::OnUpdateCameraRotation()
{
...
void NanamiEngine::Module::Component::Editor3DCamera::OnUpdateCameraPosition()
{
    if (GetMouseInput() != MOUSE_INPUT_RIGHT)
        return;
