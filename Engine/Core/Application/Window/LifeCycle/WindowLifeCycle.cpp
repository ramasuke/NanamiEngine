...
NanamiEngine::Core::Application::WindowLifeCycle::WindowLifeCycle()
...
NanamiEngine::Core::Application::WindowLifeCycle::~WindowLifeCycle() = default;

void NanamiEngine::Core::Application::WindowLifeCycle::OnUpdateForGame()
{
    ...
    ApplicationBase::Physics().UpdateContactedEvent();
...
void NanamiEngine::Core::Application::WindowLifeCycle::OnUpdateForEditor()
{
    initRenderableCallbacks_  .Invoke([](auto& obj) { obj.InitRenderer();   });
