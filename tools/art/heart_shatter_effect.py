...
白い閃光と衝撃の輪と、割れた地面のかけら。3つの浮遊石そのものはシーンの GameObject で、
BT アクション Story::ScatterFloatingStones が地面から抜け出させて三方へ飛ばす (遠景のカメラでも見える大きさにするため)。
...
def heart_shard_scatter():
    nodes = [
        ...
        N('HeartGlow', tex='glow', life=55, grow=(3.0, 5.0, 0, 0), color=a(HEART, 200),
          fade_out=(30, 0, -20)),
        # 地面に沿って広がる衝撃の輪
